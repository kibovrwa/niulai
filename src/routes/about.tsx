    ...
    <PaperPage eyebrow={en ? "About" : "关于"} title={en ? "niulai" : "牛来许愿池"}>
      {en ? (
        <>
          ...
          <p className="font-display text-cinnabar">Believe in niulai. The bull will come.</p>
          <p>Other totems keep you safe. This one is Come. Faith first. Then the market.</p>
        ...
        <>
          ...
          <p className="font-display text-cinnabar">信牛来，牛市一定来。</p>
          <p>别的图腾管平安、管姻缘。这尊管「来」。信了，牛市才来。加薪、回消息也能登，但门口这句不能改。</p>
