    ...
    <SiteChrome>
      <main className="bg-ink px-4 pb-16 pt-24 text-paper">
        <div className="mx-auto max-w-md">
          <p className="font-brush text-gold-soft">上供</p>
          <h1 className="mt-1 font-display text-4xl tracking-widest">给神一件</h1>
          <p className="mt-2 text-sm text-paper/70">
            不是商城。披红、马甲、草环、云雀，用功德请。请过的能反复穿脱。
          </p>
          <p className="mt-2 text-sm">功德 {gongde}</p>

          <div ref={stage} className="mx-auto mt-4 w-[min(78vw,320px)]">
            <TotemStage src="/art/totem-god.jpg" on={wearing} />
          </div>
                ...
                <li key={f.id}>
                  <button
                    ...
                    className={`flex min-h-12 w-full items-center justify-between rounded-sm px-4 text-left ${
                      on ? "bg-cinnabar text-paper" : "bg-wood/50"
                    }`}
                  >
                    <span>
